...
@report_routes.route('/reports/<int:report_id>')
@login_required 
@verify_club_access()
...
@report_routes.route('/download_single_report/<int:report_id>')
@login_required
@verify_club_access()
...
@report_routes.route('/clubs/manage/<int:club_id>/report-templates', methods=['POST'])
@login_required
@verify_club_access()
@admin_required
