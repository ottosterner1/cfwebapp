...
from app.models import (
    ...
    SurveyTemplate, SurveyCampaign, SurveyResponse, ClubComplianceStatus,
    SurveyStatus, SurveyOptOut
)
...
@club_management.route('/api/clubs/<int:club_id>/survey-dashboard', methods=['GET'])
@login_required
@admin_required
@verify_club_access()
...
@club_management.route('/api/clubs/<int:club_id>/survey-settings', methods=['GET', 'PUT'])
@login_required
@admin_required
@verify_club_access()
...
@club_management.route('/api/clubs/<int:club_id>/survey-analytics', methods=['GET'])
@login_required
@admin_required
@verify_club_access()
...
@club_management.route('/api/clubs/<int:club_id>/survey-quick-stats', methods=['GET'])
@login_required
@verify_club_access()
...
@club_management.route('/api/clubs/<int:club_id>/survey-export', methods=['POST'])
@login_required
@admin_required
@verify_club_access()
